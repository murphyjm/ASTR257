...
#
setup_keywords['name'] = 'ASTR257'
setup_keywords['description'] = 'ASTR257 at UCSC'
setup_keywords['author'] = 'Skemer & Prochaska'
setup_keywords['author_email'] = 'askemer@ucsc.edu'
setup_keywords['license'] = 'BSD'
setup_keywords['url'] = 'https://github.com/askemer/astr257'
#
